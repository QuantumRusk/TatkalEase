    ...
    <div className="dashboard-shell">
      ...
      <header className="dashboard-header">
        ...
        <div className="dashboard-nav-right">
          ...
          <div className="menu-wrap">
            <button className="profile-button" onClick={() => { setProfileOpen((open) => !open); setAlertsOpen(false); }} aria-expanded={profileOpen}><span>DC</span><b>Demo Citizen</b><em>⌄</em></button>
